...
namespace RestrictionOperators
{
    class Program
    {
        ...
        public class LinqSamples
        {
            ...
            [Description("This sample uses the where clause to find all customers in UK " +
            ...
            public void Linq4()
            {
                ...
                //TODO: Create code to implement the functionality listed in the [Description] tag for this query
                var waCustomers = 
                    from prod in customers
                    where prod.Country == "UK"
                    select prod;

                Console.WriteLine("Customers from UK and their orders:");
